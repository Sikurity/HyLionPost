...
def pyfcm_notify(name,message):
    ...
    result = push_service.notify_topic_subscribers(topic_name=name, message_body=message_body, sound="Default", data_message=data_message, content_available=bool(True))
